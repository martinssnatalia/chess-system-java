...
public class King extends ChessPiece{
	...
	public King(Board board, Color color, ChessMatch chesssMatch) {
		super(board, color);
	...
	public boolean[][] possibleMoves() {
		...
		if(getMoveCount() == 0 && !chesssMatch.getCheck()) {
			
			//Kingside rook
			Position posR1 = new Position(position.getRow(), position.getColumn() +3); //always king column +3, no matter piece color
